...
with (o_p15_body)
{
	if (sprite_index == s_p15sanssheet_1) { other.pure_x = pure_x + 10; other.pure_y = pure_y - 48; }
	if (sprite_index == s_p15sanssheet_6) { other.pure_x = pure_x + 10; other.pure_y = pure_y - 32; }
}

// Kanatlar eskiden tamamen hareketsizdi; hafif bir titresim ve muzik
// vurusunda disari acilma eklendi.
flutter += 0.05;
