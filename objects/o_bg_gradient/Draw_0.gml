...
if (room == room_battle_1)
{
	...
	// Cizgiler de gradientin alfasini takip ediyor. Sabit 0.07 iken
	// o_bg_gradient soldurulunce sprite kayboluyor ama cizgiler ekranda
	// kaliyordu (faz 2'nin son atagi gradienti sifira indiriyor).
