function Item_CallEvent() {
	...
	// EASY: butun itemler "MaxHeal" -- tam can veriyor, kendi olaylarini
	// oynatmiyorlar. Papyrus geldikten SONRA (global.p2_revived_pap) heal bir
	// "kandirmaca": tam can gosterilip son kutuda can = eski-10'a dusuyor.
	// -10'u dialog kuyrugu bosalinca uyguluyoruz (bkz world/Step_0), yoksa
	// oyuncu kutulari okumadan can dususunu gorurdu.
