...
// SAHNE: EASY'de karakterler script'e gore girip cikmiyor. Papyrus t15'teki
// {revive 1} ile geldigi andan itibaren SUREKLI sahnede; Sans ve Alphys de
// kaliyor ama saldirmiyorlar, sadece konusma icinler. Her Papyrus turunda
// durum yeniden sabitleniyor ki hicbir sey onlari sahneden cikaramasin.
with (battle_enemy_engage)
{
...
// EASY'ye ozel Papyrus parcasi ilk turda devreye giriyor ve geri alinmiyor:
// bundan sonrasi da onun muzigiyle oynuyor.
if (atak == 1) { Difficulty_PapyrusMuzikBasla(); }

// ---------------------------------------------------------------------------
// PAPYRUS -- YER TUTUCU METINLER
//
// Her Papyrus turunun kendi repligi var. Ton: oyuncunun kolay modu sectigini
// fark etmis ve bundan hoslanmamis durumda. Metinler gecici.
// ---------------------------------------------------------------------------
switch (atak)
{
	case 1:
