// Fare imleci kilitliyken imlecin uzerinde donen mavi kemikler.
// Sadece KENDI penceremizin icine cizilebiliyor -- masaustunun geri kalanina
// (or. tarayicinin uzerine) cizmek GameMaker'dan mumkun degil.
if (!ara_kilit) { exit; }
