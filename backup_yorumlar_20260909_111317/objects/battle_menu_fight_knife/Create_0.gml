...
// getirmiyor: Sans kolsuz kaliyor. (Eskiden p1sanshp olumden sonra
// sifirlanmadigi icin bu pencere tekrar oynayista da aciliyordu; artik
// Run_ResetState sifirliyor.) O pencerede savas zaten bitti, bloklama
// pozuna hic gerek yok.
