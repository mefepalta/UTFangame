...
if (!disc_leaving) {
    ...
    // Yazi tam gorunmeden ve MIN_HOLD dolmadan onay kabul edilmiyor: acilista
    // Z'ye basili tutan oyuncu ekrani hic gormeden geciyordu.
    ...
    if (disc_alpha <= 0) room_goto(room_battle_1);
}
