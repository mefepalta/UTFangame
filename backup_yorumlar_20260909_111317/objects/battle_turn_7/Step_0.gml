...
{
	// NORMAL/EASY: iki surekli akis (% 10 == 2 ve % 10 == 7) 52-980 arasi
	// 928 kare boyunca ayni deseni tekrarliyor. 579 -> 959 bunun 380 karesini
	// atliyor; ikisi de 10 modunda 9, yani akis fazi bozulmuyor. Gate dizisi
	// (360-568) o noktada bitmis oluyor, sadece 640 ve 860 patlamalari dusuyor.
	if (Difficulty_AtakKisa()) and (_timer == 579) { _timer = 959; }

	// 1580-1960 arasi 40 karede bir ayni dalga (10 tane). 1739 -> 1899 dordunu
	// atliyor; ikisi de 40 modunda 19, hizalanma korunuyor.
	...
	if (_timer == 2040)
	{
		...
		Battle_SetMenuDialog("* He never says her name.")
