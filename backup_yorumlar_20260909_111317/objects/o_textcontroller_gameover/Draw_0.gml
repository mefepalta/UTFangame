...
// Iki secenek ipucu. Ucgen prompt ekranin ortasinda oldugu icin bunlar
// kenarlara koyuldu, ust uste binmiyorlar.
if (prompt_a > 0.001) {
    draw_set_font(font_determination_sans);
    draw_set_alpha(prompt_a * 0.7);
    // valign bottom: fa_top ile yazi 480'in altina tasip kirpiliyordu.
