// FAZ 1 BITIS PENCERESI: global.p1sanshp true iken battle_enemy_engage/Step_0
// room_battle'i 125 kare (~2 sn) daha ekranda tutup room_p15'e geciyor.
// Orasi bir ara sahne, tur degil. Menu girdisi acik kalirsa oyuncu o 2
// saniyede saldirabiliyor ve Sans kolsuz kaliyordu. Girdiyi kapat.
if(_state==BATTLE_STATE.MENU) and (!(global.p1sanshp and room == room_battle)){
	if(_menu==BATTLE_MENU.BUTTON){
		// EASY final: oyuncu FIGHT'a kilitli, baska dugmeye gecemiyor.
