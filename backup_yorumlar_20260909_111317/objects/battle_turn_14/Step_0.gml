...
{
	// NORMAL/EASY: 2180-3360 arasi kendi basina bir set-piece (SeaStep+PlatStep,
	// RipMake/AlphysShocker dalgalari). Komple atlaniyor: 4170 -> 2990 kare.
	// Hedef TAM 3360; 3359 olsaydi ustteki "> 2312 and < 3360" penceresi bir kare
	// acilip sea/plat dizileri hic kurulmadan adimlanirdi.
