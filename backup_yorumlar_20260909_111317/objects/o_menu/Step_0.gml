		...
		if (!transitioning)
			{
				...
				// EASY: oyuna gecmeden once kaydirilabilir disclaimer duvari.
				// StartRun hedefi yine room_area_beforesans (kayit/olum donusu
				// dogru kalsin); sadece ilk gidilen oda disclaimer.
