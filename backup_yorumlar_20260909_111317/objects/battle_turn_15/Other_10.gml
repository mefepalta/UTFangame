...
if (room == room_battle_1)
{
	...
	if (Difficulty_Easy())
	{
		// EASY: Papyrus SESSIZCE sahnede. "Back from the dead" repligi ve
		// dirilis mini-oyunu yok; sadece sahneye snap'leniyor ve tur hemen
		// basliyor (diyalog kutusu yaratilmadan).
