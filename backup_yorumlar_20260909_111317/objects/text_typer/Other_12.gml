...
switch(cmd[|0]){
		...
		if(is_string(cmd[|1])){
			...
			switch(color){
				case c_white:
					...
					_color_shadow[0]=make_color_rgb(1,0,0);
					_color_shadow[1]=make_color_rgb(1,0,0);
					_color_shadow[2]=make_color_rgb(1,0,0);
					_color_shadow[3]=make_color_rgb(1,0,0);
					break;
					
				case c_yellow:
					_color_text[0]=make_color_rgb(255,255,60);
					_color_text[1]=make_color_rgb(255,255,60);
				...
				case c_red:
					...
					_color_text[2]=make_color_rgb(255,0,0);
					_color_text[3]=make_color_rgb(255,0,0);
				...
				case c_black:
					...
					break;
				case c_fuchsia:
					_color_text[0]=c_fuchsia;
					_color_text[1]=c_fuchsia;
					_color_text[2]=c_fuchsia;
					_color_text[3]=c_fuchsia;
					_color_shadow[0]=make_color_rgb(0,0,0);
					_color_shadow[1]=make_color_rgb(0,0,0);
					_color_shadow[2]=make_color_rgb(0,0,0);
					_color_shadow[3]=make_color_rgb(0,0,0);
	...
	case "face_link":
		if(is_real(cmd[|1])){
			battle_enemy_engage._head_image=cmd[|1];
		}
		break;
	case "body_link":
		if(is_real(cmd[|1])){
			battle_enemy_engage._body_image=cmd[|1];
		}
		break;
	case "legs_link":
		if(is_real(cmd[|1])){
			battle_enemy_engage._legs_image=cmd[|1];
		}
		break;
	...
	case "face_p":
		if(is_real(cmd[|1])){
			battle_enemy_phase_3._head_image=cmd[|1];
		}
		break;
	case "left_p":
		if(is_real(cmd[|1])){
			battle_enemy_phase_3._left_arm_image=cmd[|1];
		}
		break;
	case "face_papyrus":
		if(is_real(cmd[|1])){
			battle_fake_enemy_papyrus.papyrus_head_image=cmd[|1];
		}
		break;
	case "effect":
		if(is_real(cmd[|1])){
	...
	case "body":
        ...
        break;
	case "bubble_xscale":
        battle_dialog_enemy.xscale_box = cmd[|1];
        break;
	case "bubble_yscale":
        battle_dialog_enemy.yscale_box = cmd[|1];
        break;
	case "spike_":
        battle_dialog_enemy.SPIKE = cmd[|1];
        break;
	case "side_":
        battle_dialog_enemy.SIDE = cmd[|1];
        break;
	case "squish":
	...
	case "revive":
        ...
        var _rev_done=(variable_global_exists(_rev_key) ? variable_global_get(_rev_key) : false);
	...
	case "side":
        // Konusma balonunu belli tarafa zorla (-1 otomatik, 0 sag, 1 sol).
