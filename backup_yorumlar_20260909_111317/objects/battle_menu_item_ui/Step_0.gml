...
switch slot
{
	...
	battle_soul.y=lerp(battle_soul.y,battle_board.y-battle_board.up-5+36,0.5);
	break;
	
	case 1:
	case 5:
	battle_soul.x=lerp(battle_soul.x,battle_board.x-battle_board.left-5+40+256,0.5);
	battle_soul.y=lerp(battle_soul.y,battle_board.y-battle_board.up-5+36,0.5);
	break;
	...
	case 6:
	battle_soul.x=lerp(battle_soul.x,battle_board.x-battle_board.left-5+40,0.5);
	battle_soul.y=lerp(battle_soul.y,battle_board.y-battle_board.up-5+36+32,0.5);
	break;
