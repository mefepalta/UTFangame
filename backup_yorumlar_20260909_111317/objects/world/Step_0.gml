...
// EASY MaxHeal kandirmacasi: "...just kidding!" kutusu kapaninca (dialog
// kuyrugu bosalinca) can eski-10'a dusuyor. Item_CallEvent kuruyor.
...
if(!variable_instance_exists(id,"_quit_hold_time")){
	...
	_quit_alpha=0;
	_quit_dot_count=0;
	_quit_kidding=false;   // ara sahne: cikis yerine "JUST KIDDING ;)"
}
...
if(keyboard_check(vk_escape)){
	...
	if(_quit_hold_time>=90){
		// Papyrus'un mola ara sahnesinde cikis "kandirmaca": QUITTING...
		// yaziyor ama tam kapanacakken oyunu kapatmiyor, dalga geciyor.
