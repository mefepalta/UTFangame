...
if (room == room_battle)
{
	...
	// EASY: Sans faz 1 boyunca "gicik olmus" ifadesinde kaliyor (kafa kare 3).
	// EASY'de zaten hicbir Sans repligi yok (hepsi "..."), yani sahnelerin
	// {head N} etiketleriyle cakismiyor. p1sanshp penceresi disarida: orada
	// yukaridaki blok kareyi 15'e zorluyor, o faz 1'in bitis pozu.
...
if (room == room_battle_1)
{
	...
	// EASY: Sans faz 2 boyunca da "gicik" ifadesinde (kafa kare 4), faz 1'e
	// benzer. EASY'de Sans repligi zaten hep "..." oldugu icin sahne
	// {head N} etiketleriyle carpismiyor.
	if (Difficulty_Easy()) { _head_image = 4; }
}

// EASY'de KR faz 1'de de kapali: hasar zaten Player_Hurt'te 1'e sabitleniyor,
// KR yigilmasi o hasarin ustune tek anlamli ceza olarak kalirdi.
