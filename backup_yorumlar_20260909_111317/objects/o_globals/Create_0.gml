...
// Ara sahne cikis kandirmacasi (bkz battle_turn_28 mola).
global.no_quit = false;

// Faz 2 finalinde ataklarin 4 vurmasi (bkz battle_turn_28 atak 10).
global.easy_dmg4 = false;

// EASY MaxHeal kandirmacasi: bekleyen can dususu (-1 = yok).
global.easy_heal_kid = -1;

// EASY final: son atak sonrasi FIGHT kilidi + ozel bitis odasi.
