...
if (room == room_battle_1)
{
	...
	if (Difficulty_Easy())
	{
		sansy.text = "{easy_raw}{revive 2}{speaker 2}{font 2}{voice 2}{alp_head 1}It's bad,&I'm disappointed.{pause}{clear}{speaker 0}{font 3}{voice 3}{head 4}...{pause}{clear}{speaker 2}{font 2}{voice 2}{alp_head 4}It's all your&fault Mefe.{pause}{clear}{side 1}{speaker 2}{font 2}{voice 2}{alp_head 0}Now my favorite&Undertale Youtuber&MoRoN will not&no hit this.{pause}{clear}{speaker 9}{font 0}{voice 0}I guess...";
	}
	else
	{
