...
{
	// NORMAL/EASY: 1280-1640 arasi 60 karede bir dalga, deseni
	// (_timer div 60) % 3 ile donuyor. 1339 -> 1519 uc dalgayi atliyor:
	// fark 180 = 3*60, yani hem % 60 == 20 hizalanmasi hem de gruplu dongu
	// aynen korunuyor (1339 div 60 = 22, 1519 div 60 = 25, ikisi de %3 == 1).
