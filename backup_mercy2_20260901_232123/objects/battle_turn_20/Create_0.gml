	...
	switch (isin_faz)
	{
		...
		case 2:	// isin -- ekran sarsiliyor, hasar acik
			...
			if (instance_exists(battle_soul))
			{
				...
				//
				// HASAR: Battle_CallSoulEventBulletCollision KULLANILMIYOR.
				// O fonksiyon once Battle_IsBulletValid(id) diye soruyor ve
				// buradaki id TUR NESNESI -- battle_bullet soyundan gelmedigi
				// icin kontrol daima false donuyor, yani isin hic hasar
				// vermiyordu. Mermi olmayan tehlikelerin yolu HURT olayini
				// dogrudan cagirmak; dokunulmazligi da burada kendimiz
				// kontrol ediyoruz (battle_soul/Other_10'un yaptigi gibi).
