...
//
// s_p1final_sansfall_1 22 karelik ve 21'den 0'a dogru oynuyor. Kareyi de
// buradan suruyoruz ki animasyon tam olarak inis boyunca bitsin. Alt sinir
// 0.5: nesnenin kendi Step'i image_index tam 0 olunca kendini yok ediyor,
// biz ise cikisi capraz solmayla yapiyoruz.
//==========================================================================
#macro T20_FIN_DUS_BAS  5500	/// inisin basladigi kare
#macro T20_FIN_DUS_SURE  105	/// inis suresi (22 kare / 12 fps = 105 kare)
#macro T20_FIN_DUS_Y    -256	/// inisin bittigi y
...
FinDusAdim = function()
{
	...
	with (o_p1final_fall_1)
	{
		...
		target_y = y;
		// Kare, gecen SUREYE degil ALINAN YOLA bagli: hizli inerken
		// animasyon hizli, konarken yavas oynuyor.
		image_index = 0.5+20.5*(1-_f);
	}
