...
instance_create_depth(32,429,0,battle_button_fight);
instance_create_depth(185,429,0,battle_button_act);
instance_create_depth(345,429,0,battle_button_item);
instance_create_depth(500,429,0,battle_button_mercy);
instance_create_depth(0,0,0,window_shaker);
